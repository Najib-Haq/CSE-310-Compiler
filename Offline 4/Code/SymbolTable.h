...
public:
    ...
    // for ICG
    string code = ""; // holds the corresponding code
    string symbol = ""; // var name or register(?)
    ...
    SymbolInfo(string name, string type, string value_type, string return_type, string symbol){
        this->name = name;
        this->type = type;
        this->next = nullptr;
        this->value_type = value_type;
